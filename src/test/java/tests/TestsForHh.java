...
public class TestsForHh extends TestBase {
    ...
    void hhTest01() {
        step("open the link", () -> {
            open("/vacancy?text=QA+engineer+%D0%B5%D0%BA%D0%B0%D1%82%D0%B5%D1%80%D0%B8%D0%BD%D0%B1%D1%83%D1%80%D0%B3+java&from=suggest_post&salary=&clusters=true&area=3&ored_clusters=true&enable_snippets=true");
        });
